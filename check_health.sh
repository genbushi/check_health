#!/bin/bash
# Author : vsw
# Blog site : https://www.vswsystems.com
# Github page : https://github.com/genbushi/check_health
# Purpose : To quickly check and report health status in a linux system.
# OS : RHEL8(beta)/7/6/5/, SLES/SLED 12/11, Ubuntu14/16/18, Debian
# Version : v1018
...
echo -e "\n\t\t %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
echo -e "\t\t   <>------------<> Thank You : https://www.vswsystems.com <>------------<>"
echo -e "\t\t %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
